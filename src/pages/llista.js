...
const llista = [
    ...
    { path:"/graella-fotos", titol: "Graella de fotos", element: <GraellaFotos />},
    { path:"/acordio", titol: "Acordio", element: <Acordio />},
    { path:"/toggle-button", titol: "Toggle button", element: <ToggleButton />},
    { path:"/comptador-useState", titol: "Comptador useState", element: <ComptadorUseState />},
    { path:"/comptador-useReducer", titol: "Comptador useReducer", element: <ComptadorUseReducer />},
    { path:"/comptador-Redux", titol: "Comptador Redux", element: <ComptadorRedux />},
]
